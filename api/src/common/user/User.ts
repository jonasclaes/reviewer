...
export class User implements IUser {
    ...
    public save(): Promise<void> {
        if (this.id == null) {
            ...
            return new Promise((resolve, reject) => {
                database.getConnection().query("INSERT INTO `users` (`id`, `firstName`, `lastName`, `username`, `email`, `password`, `googleId`, `role`) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?)", [this.firstName, this.lastName, this.username, this.email, this.password, this.googleId, this.role], (err, results, fields) => {
